...
import com.example.veterinarinary.DTO.RoleAssignDTO;
import com.example.veterinarinary.DTO.UserDTO;
import com.example.veterinarinary.model.User;
import com.example.veterinarinary.service.UserService;
...
public class UserController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or #id == principal.id") // Admin o usuario dueño de su perfil
